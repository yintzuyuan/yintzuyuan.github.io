...
window.UI_DATA = {
  zh: {
    ...
    // Tools
    'tools.page.title': '工具',
    'tools.page.desc': '字型設計師打造的工具——Glyphs 外掛、iOS App、腳本與開發資源。',
    'tools.section.featured': 'Featured',
    'tools.section.apps': 'Apps',
    'tools.section.plugins': 'Plugins',
    'tools.section.scripts': 'Scripts & Resources',
    'tools.panda.title': '胖打注音',
    'tools.panda.desc': '為粗手指打造的注音輸入法。Layered-Expand 12 鍵佈局、注音語音學分組、候選區情境變體。',
    'tools.panda.f1': 'Layered-Expand',
    'tools.panda.f2': '語音學分組',
    'tools.panda.f3': '情境變體候選',
    'tools.panda.f4': '完全離線',
    'tools.panda.cta': '了解更多',
  ...
  en: {
    ...
    'tools.page.desc': 'Tools by a type designer\u2014Glyphs plugins, iOS apps, scripts, and developer resources.',
    'tools.section.featured': 'Featured',
    'tools.section.apps': 'Apps',
    'tools.section.plugins': 'Plugins',
    'tools.section.scripts': 'Scripts & Resources',
    'tools.panda.title': 'Panda Zhuyin',
    'tools.panda.desc': 'A Bopomofo IME designed for thick fingers. 12-key Layered-Expand layout with phonological grouping and contextual candidate variants.',
    'tools.panda.f1': 'Layered-Expand',
    'tools.panda.f2': 'Phonological Grouping',
    'tools.panda.f3': 'Contextual Candidates',
    'tools.panda.f4': 'Fully Offline',
    'tools.panda.cta': 'Learn More',
